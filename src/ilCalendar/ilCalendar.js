...
angular.module("il.ui.calendar", ['ngSanitize','pascalprecht.translate','ui.bootstrap'])
	.directive('ilCalendar', function() {
		var controller = ['$scope','$timeout','$attrs', function ($scope,$timeout,$attrs) {
			$scope.id="il_Calendar"+Math.floor(Math.random()*1000)
			...
			$("#"+$scope.id).fullCalendar({
				defaultView:byDefault($scope.view,"agendaWeek"),
